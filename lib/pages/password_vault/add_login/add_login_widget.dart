...
import 'add_login_model.dart';
export 'add_login_model.dart';

class AddLoginWidget extends StatefulWidget {
  const AddLoginWidget({super.key});

  static String routeName = 'AddLogin';
  static String routePath = '/addLogin';

  @override
  State<AddLoginWidget> createState() => _AddLoginWidgetState();
}

class _AddLoginWidgetState extends State<AddLoginWidget> {
  late AddLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddLoginModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(24.0, 50.0, 24.0, 10.0),
                child: Text(
                  'LOGIN DETAILS',
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.encryptedPwd = await actions.encryptPlaintext(
                        _model.passwordTextController.text,
                        FFAppState().symmetricKey,
                        FFAppState().initVector,
                      );

                      var vaultItemsRecordReference =
                          VaultItemsRecord.collection.doc();
                      await vaultItemsRecordReference
                          .set(createVaultItemsRecordData(
                        email: _model.emailAddressTextController.text,
                        password: _model.encryptedPwd,
                        website: _model.websiteTextController.text,
                        note: _model.noteTextController.text,
                        user: currentUserUid,
                      ));
                      _model.vaultItem = VaultItemsRecord.getDocumentFromData(
                          createVaultItemsRecordData(
                            email: _model.emailAddressTextController.text,
                            password: _model.encryptedPwd,
                            website: _model.websiteTextController.text,
                            note: _model.noteTextController.text,
