...
class GeneratorWidget extends StatefulWidget {
  ...
  static String routeName = 'Generator';
  static String routePath = '/generator';
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            await Clipboard.setData(
                                ClipboardData(text: _model.generatedPwd!));
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(18.0, 30.0, 0.0, 5.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(18.0, 5.0, 0.0, 10.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Theme(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        _model.generatedPwd = await actions.generatePassword(
                          _model.sliderValue!,
