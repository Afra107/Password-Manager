...
class UpdateLoginWidget extends StatefulWidget {
  const UpdateLoginWidget({
    ...
    required this.initialPwd,
  });

  final VaultItemsRecord? initialDetails;
  final String? initialPwd;

  static String routeName = 'updateLogin';
  static String routePath = '/updateLogin';
...
class _UpdateLoginWidgetState extends State<UpdateLoginWidget> {
  ...
  void initState() {
    ...
    _model.emailAddressTextController ??=
        TextEditingController(text: widget.initialDetails?.email);
    ...
    _model.websiteTextController ??=
        TextEditingController(text: widget.initialDetails?.website);
    _model.websiteFocusNode ??= FocusNode();

    _model.noteTextController ??=
        TextEditingController(text: widget.initialDetails?.note);
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await widget.initialDetails!.reference
                          .update(createVaultItemsRecordData(
