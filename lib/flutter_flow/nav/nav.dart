...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AddLoginWidget.routeName,
          path: AddLoginWidget.routePath,
          builder: (context, params) => AddLoginWidget(),
        ),
        FFRoute(
          name: ViewLoginWidget.routeName,
          path: ViewLoginWidget.routePath,
          asyncParams: {
            'itemDetail':
                getDoc(['vault_items'], VaultItemsRecord.fromSnapshot),
          },
          builder: (context, params) => ViewLoginWidget(
            itemDetail: params.getParam(
              'itemDetail',
              ParamType.Document,
            ),
            decryptedPwd: params.getParam(
              'decryptedPwd',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: UpdateLoginWidget.routeName,
          path: UpdateLoginWidget.routePath,
          asyncParams: {
            'initialDetails':
                getDoc(['vault_items'], VaultItemsRecord.fromSnapshot),
          },
          builder: (context, params) => UpdateLoginWidget(
            initialDetails: params.getParam(
              'initialDetails',
              ParamType.Document,
            ),
            initialPwd: params.getParam(
              'initialPwd',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: GeneratorWidget.routeName,
          path: GeneratorWidget.routePath,
          builder: (context, params) => GeneratorWidget(),
        ),
        FFRoute(
          name: SettingsWidget.routeName,
          path: SettingsWidget.routePath,
          builder: (context, params) => SettingsWidget(
            initial2FAState: params.getParam(
              'initial2FAState',
              ParamType.bool,
            ),
